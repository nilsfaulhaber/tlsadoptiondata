...
with open(OUTPUT_FOLDER + 'tlsadoption_v4.csv', 'a') as csvFile:
...
with open("tls13_tls12_SupportingUrls.txt","w") as txtFile:
...
with open(OUTPUT_FOLDER + "overlap_v4.csv", "a") as csvFile:
    writer = csv.writer(csvFile)
    writer.writerow(row)
